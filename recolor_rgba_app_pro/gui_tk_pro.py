    ...
    def run(self):
        while True:
            ...
            try:
                ...
                continue
            self.app.after(0, lambda res=result, gen=generation, iid=image_id: self.app._on_preview_ready(gen, iid, res))
...
class App(tk.Tk):
    ...
    def _run_preview(self, generation, blocking=False):
        ...
        if blocking or self._preview_worker is None:
            ...
            self._on_preview_ready(generation, self._image_serial, result)
        else:
    ...
    def _on_preview_ready(self, generation, image_id, out):
